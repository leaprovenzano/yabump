.. _issues: https://github.com/leaprovenzano/yabump/issues
...
* Any details about your local setup that might be helpful in troubleshooting. This must include your version of python and yabump
...
1. Fork the yabump repo on GitHub.
2. Clone your fork locally::

    $ git clone git@github.com:your_name_here/yabump.git

3. Install your local copy into a virtualenv::

    $ python3 -m yabump/env
    $ cd yabump
